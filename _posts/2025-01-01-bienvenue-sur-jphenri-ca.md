---
layout: post
title: "Bienvenue sur jphenri.ca"
lang: fr
---

Bienvenue sur **jphenri.ca** 👋  
...
Ici, je peux structurer les idées, les rendre trouvables et les faire évoluer.

---

## Ce que tu vas trouver ici

- Des articles techniques (Intune, Trellix, Linux, etc.)
- Des réflexions sur l’IA appliquée aux PME
- Des journaux de lab (ce qui marche… et ce qui brise tout 😅)
- Des études de cas (comme **Chez Gerry 1958** et d’autres projets)

Si tu es :
- admin TI / analyste / devops,
- propriétaire de PME curieux côté techno,
- ou juste nerd de home lab,

tu devrais trouver de quoi te nourrir ici.

---

## Et la suite ?

Je vais ajouter au fil du temps :
